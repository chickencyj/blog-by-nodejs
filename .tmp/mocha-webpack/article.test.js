...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(__dirname) {const express = __webpack_require__(4);
	const path = __webpack_require__(5);
	const favicon = __webpack_require__(6);
	const logger = __webpack_require__(7);
	const cookieParser = __webpack_require__(8);
	const bodyParser = __webpack_require__(9);
	const session = __webpack_require__(10);


	const mongoose = __webpack_require__(11);
	const mongoStore = __webpack_require__(12)(session);
	...
	//动态视图助手，本地变量
	app.locals.moment = __webpack_require__(13);


	const main = __webpack_require__(14)(app);
	const admin = __webpack_require__(16)(app);
	const api = __webpack_require__(17)(app);
	const manager = __webpack_require__(18)(app);
	//模块挂载
	app.use('/', main);
	app.use('/admin', admin);
	app.use('/api', api);
...
/***/ function(module, exports, __webpack_require__) {
	...
	const path = __webpack_require__(5);
	mainApp.locals.moment = __webpack_require__(13);
	...
	mainApp.use( (req, res, next) => {
	  ...
	  next();
		...
		//路由模块
		const routers = {
			main: __webpack_require__(15)(path.join(__dirname, '../app/controller/main/main')),
			user: __webpack_require__(15)(path.join(__dirname, '../app/controller/main/user'))
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	let admin = (app) => {
		...
		//路由模块
		const routers = {
			article: __webpack_require__(15)(path.join(__dirname, '../app/controller/admin/article')),
			user: __webpack_require__(15)(path.join(__dirname, '../app/controller/admin/user'))
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	let api = (app) => {
		...
		//路由模块
		const routers = {
			main: __webpack_require__(15)(path.join(__dirname, '../app/controller/api/main')),
			user: __webpack_require__(15)(path.join(__dirname, '../app/controller/api/user')),
			showmore: __webpack_require__(15)(path.join(__dirname, '../app/controller/api/showmore'))
		};
		//主模块
...
/***/ function(module, exports, __webpack_require__) {
	...
	let manager = (app) => {
		...
		//路由模块
		const routers = {
			main: __webpack_require__(15)(path.join(__dirname, '../app/controller/manager/main'))
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	const Index = __webpack_require__(20);
	const Post = __webpack_require__(27);
	const Users = __webpack_require__(31);
	const Author = __webpack_require__(34);
...
/***/ function(module, exports, __webpack_require__) {
	...
	const mongoose = __webpack_require__(11);
	const ArticleSchema = __webpack_require__(22);
	/**
...
/***/ function(module, exports, __webpack_require__) {
	...
	const mongoose = __webpack_require__(11);
	const UserSchema = __webpack_require__(24);
	/**
	 * [Movie description] 编译生成movie模型
	 * @type {[type]} 第一个参数为这个模型的名字，第二个参数为模型骨架
	 */
...
/***/ function(module, exports, __webpack_require__) {
	...
	const mongoose = __webpack_require__(11);
	const TagSchema = __webpack_require__(29);
	/**
	 * [Movie description] 编译生成movie模型
	 * @type {[type]} 第一个参数为这个模型的名字，第二个参数为模型骨架
	 */
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(__dirname) {const User = __webpack_require__(23),
				multer  = __webpack_require__(32),
